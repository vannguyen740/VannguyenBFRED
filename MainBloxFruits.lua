                        ...
                        if (v1433:FindFirstChild("Humanoid") and v1433:FindFirstChild("HumanoidRootPart") and (v1433.Humanoid.Health > 0)) then
                            if (v1433.Name == Ms) then
                                repeat
                                    ...
                                    MonFarm = v1433.Name;
                                until not _G.AutoLevel or not v1433.Parent or (v1433.Humanoid.Health <= 100) or not game:GetService("Workspace").Enemies:FindFirstChild(v1433.Name) or (game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false)
                                bringmob = true;
                            end
                        end
                    end
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Mày Có: " .. tostring(v768) .. " Bone");
            end
        end);
    end);
