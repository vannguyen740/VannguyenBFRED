...
shared.LoaderTitle = "Van Nguyen Hub";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://75232584006639",
...
v14:Notify({
    Title = "Van Nguyen",
    Content = "Ui True Game Script Blox fruit Start Updated script Attack=Click On The Thank you Can play ✅",
    Duration = 5
});